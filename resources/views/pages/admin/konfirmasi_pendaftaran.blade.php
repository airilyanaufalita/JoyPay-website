                    ...
                    <div class="row mb-4">
                        <div class="col-md-3 mb-3">
                            <div class="stats-card">
                                ...
                                <div class="stats-number" id="totalCount">{{ $stats['total'] }}</div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="stats-card">
                                ...
                                <div class="stats-number" id="pendingCount">{{ $stats['pending'] }}</div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="stats-card">
                                ...
                                <div class="stats-number" id="approvedCount">{{ $stats['approved'] }}</div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="stats-card">
                                ...
                                <div class="stats-number" id="rejectedCount">{{ $stats['rejected'] }}</div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" id="registrationsTable">
                                ...
                                <tbody id="registrationsBody">
                                    @if($users->count() > 0)
                                        @foreach($users as $user)
                                        <tr data-status="{{ $user->status }}" data-type="{{ $user->type }}" data-date="{{ $user->created_at }}" data-user-id="{{ $user->id }}">
                                            <td>
                                                <input type="checkbox" class="form-check-input select-registration" value="{{ $user->id }}" {{ $user->status !== 'pending' ? 'disabled' : '' }}>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                            ...
                                            <td>
                                                ...
                                                <div><strong>Bank:</strong> 
                                                    @if($user->bank)
                                                        <span class="bank-badge">{{ strtoupper($user->bank) }}</span>
                                                    @else
                                                        -
                                                    @endif
                                                </div>
                                                <div><strong>Rekening:</strong> {{ $user->account_number ?? '-' }}</div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <small class="text-muted">
                                                    @if($user->status === 'pending')
                                                        -
                                                    @elseif($user->status === 'approved' && $user->approvedBy)
                                                        {{ $user->approvedBy->name }}
                                                    @elseif($user->status === 'rejected' && $user->rejectedBy)
                                            ...
                                            <td>
                                                @if($user->status === 'pending')
                                                    <button class="btn btn-success btn-action btn-sm" onclick="approveRegistration({{ $user->id }})">
                                                        <i class="fas fa-check"></i>
                                                    </button>
                                                    <button class="btn btn-danger btn-action btn-sm" onclick="showRejectionModal({{ $user->id }})">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                    <button class="btn btn-info btn-action btn-sm" onclick="viewRegistration({{ $user->id }})">
