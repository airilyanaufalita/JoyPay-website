            ...
            <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="input-group full-width">
                        ...
                        <input type="text" id="address" name="address" placeholder="Alamat Lengkap" value="{{ old('address') }}">
                        @error('address') <div class="error-message">{{ $message }}</div> @enderror
                    </div>

                    <div class="input-group">
                        <label for="phone">Nomor HP</label>
                        <input type="tel" id="phone" name="phone" placeholder="Nomor HP" value="{{ old('phone') }}">
                        @error('phone') <div class="error-message">{{ $message }}</div> @enderror
                    </div>

                    <div class="input-group">
                        <label for="emergency_phone">Nomor Darurat</label>
                        <input type="tel" id="emergency_phone" name="emergency_phone" placeholder="Nomor Darurat" value="{{ old('emergency_phone') }}">
                        @error('emergency_phone') <div class="error-message">{{ $message }}</div> @enderror
                    </div>

                    <div class="input-group">
                        <label for="social_media">Media Sosial</label>
                        <input type="text" id="social_media" name="social_media" placeholder="Media Sosial" value="{{ old('social_media') }}">
                        @error('social_media') <div class="error-message">{{ $message }}</div> @enderror
                    </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="custom-select">
                                ...
                                <select id="bank" name="bank" required>
                                    ...
                                    <option value="bca" {{ old('bank') == 'bca' ? 'selected' : '' }}>Bank BCA</option>
                                    <option value="mandiri" {{ old('bank') == 'mandiri' ? 'selected' : '' }}>Bank Mandiri</option>
                                    <option value="bni" {{ old('bank') == 'bni' ? 'selected' : '' }}>Bank BNI</option>
                                    <option value="bri" {{ old('bank') == 'bri' ? 'selected' : '' }}>Bank BRI</option>
                                    <option value="danamon" {{ old('bank') == 'danamon' ? 'selected' : '' }}>Bank Danamon</option>
                                    <option value="cimb" {{ old('bank') == 'cimb' ? 'selected' : '' }}>CIMB Niaga</option>
                                    <option value="bsi" {{ old('bank') == 'bsi' ? 'selected' : '' }}>Bank Syariah Indonesia</option>
                                    <option value="btn" {{ old('bank') == 'btn' ? 'selected' : '' }}>Bank BTN</option>
                                    <option value="permata" {{ old('bank') == 'permata' ? 'selected' : '' }}>Bank Permata</option>
                                    <option value="mega" {{ old('bank') == 'mega' ? 'selected' : '' }}>Bank Mega</option>
                                    <option value="bukopin" {{ old('bank') == 'bukopin' ? 'selected' : '' }}>Bank Bukopin</option>
                                    <option value="panin" {{ old('bank') == 'panin' ? 'selected' : '' }}>Panin Bank</option>
                                </select>
                                @error('bank') <div class="error-message">{{ $message }}</div> @enderror
                            </div>
                        </div>

                        <div class="input-group">
                            <label for="account_number">Nomor Rekening</label>
                            <input type="text" id="account_number" name="account_number" placeholder="Nomor Rekening" value="{{ old('account_number') }}" required>
                            @error('account_number') <div class="error-message">{{ $message }}</div> @enderror
                        </div>
                    </div>
