...
<body>
    <div class="login-form">
        ...
        <div class="form-panel">
            <a href="<?php echo e(route('home')); ?>" class="back-btn">Kembali ke Beranda</a>
            <h2>Login</h2>
            ...
            <form action="<?php echo e(route('login')); ?>" method="POST">
                ...
                <div class="input-group">
                    ...
                    <input type="email" id="email" name="email" placeholder="Masukkan email Anda" value="<?php echo e(old('email')); ?>" required>
...
</html><?php /**PATH C:\xampp\htdocs\joypayy\resources\views/auth/login.blade.php ENDPATH**/ ?>