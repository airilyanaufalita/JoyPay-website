        ...
        <div class="hero-container">
            ...
            <div class="hero-visual">
                <div class="laptop-container">
                     <img src="<?php echo e(asset('images/2laptop.png')); ?>" alt="Laptop showing Arisan Barokah platform" class="laptop-image">
...
<!-- Testimonial Section -->
    <section class="testimonial-section">
        <div class="container">
            ...
            <p class="section-description animate-on-scroll">
                Ulasan dari pengguna yang puas dengan layanan Arisan Barokah
            </p>
            
            
<div class="testimonial-grid">
    <?php $__empty_1 = true; $__currentLoopData = $testimonis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimoni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="testimonial-card animate-on-scroll">
        <p class="testimonial-text">
            "<?php echo e($testimoni->testimoni); ?>"
        </p>
        <div class="testimonial-author"><?php echo e($testimoni->nama); ?></div>
        <div class="testimonial-role"><?php echo e($testimoni->pekerjaan); ?></div>
    </div>
    ...
    <div class="testimonial-card animate-on-scroll">
        ...
        <div class="testimonial-role">Arisan Barokah</div>
    </div>
    <?php endif; ?>
</div>
            ...
            <div class="testimoni-action animate-on-scroll" style="text-align: center; margin-bottom: 40px;">
                <a href="<?php echo e(route('testimoni.create')); ?>" class="btn-testimoni">
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <div class="cta-buttons animate-on-scroll">
                <a href="<?php echo e(route('kloter.aktif')); ?>" class="btn btn-primary">
...
</html><?php /**PATH C:\xampp\htdocs\joypayy\resources\views/pages/home.blade.php ENDPATH**/ ?>